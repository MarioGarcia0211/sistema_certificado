    ...
    <div class="contenedor">
        ...
        <nav class="navbar">
            <div class="container-fluid">
                ...
                <div class="d-flex">
                    <a class="btn btn-danger" target="_blank" href="generar_pdf.php?idCurso=<?php echo $idCurso ?>&busqueda=<?php echo $busqueda ?>"><i class="bi bi-filetype-pdf"></i></a>

                    <a class="btn btn-success" target="_blank" href="generar_xls.php?idCurso=<?php echo $idCurso ?>&busqueda=<?php echo $busqueda ?>"><i class="bi bi-file-earmark-excel"></i></a>
                </div>
                <form class="d-flex" role="search" action="buscar_asistencia.php" method="get">
                    <input id="idCurso" type="hidden" name="idCurso" value="<?php echo $idCurso ?>">
                    <input class="form-control me-2" type="date" value="<?php echo $busqueda ?>" name="busqueda" id="busqueda" placeholder="Buscar" aria-label="Search">
